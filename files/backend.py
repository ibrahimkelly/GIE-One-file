...
class DataBase:
    def __init__(self):
        ...
        (
            ...
            prenom BLOB(19) DEFAULT '',
            surnom BLOB(19) DEFAULT '',
            nom BLOB(19) DEFAULT '',
            ...
            prenom_tuteur BLOB(19) DEFAULT '',
            nom_tuteur BLOB(19) DEFAULT '',
            telephone_tuteur INTEGER DEFAULT '',
            adresse_tuteur BLOB(19) DEFAULT ''
        );
